...
public class StudentService implements StudentServiceInf{
	...
	* Method 설명 : 해당 페이지 * pageSize 를 매개변수로 받아 페이지에 맞는 회원정보만을 가져오는 메서드 
	 */
	@Override
	public Map<String,Object> getStudentPageList(HashMap<String, Integer> page) {
		Map<String,Object> resultMap = new HashMap<String,Object>();
		//학생 페이지 리스트 조회
		List<StudentVo> pageList = studentDao.getStudentPageList(page);
	...
	* Method 설명 : 페이지 네이게이션  문자열 생성 
	 */
	private String makePageNavi(int totCnt,HashMap<String, Integer> page){
		//페이지 네이게이션 html 생성 
		...
		pageNavi.append("<li><a href=\"studentList?page="+(activePage>1?activePage-1:1)+"&pageSize=10\" aria-label=\"Previous\"><span aria-hidden=\"true\">&laquo;</span></a></li>");
...
//			}
			...
			pageNavi.append("<li"+activeClass+"><a href=\"/studentList?page="+i+"&pageSize=10\">"+i+"</a></li>");
		}
	    pageNavi.append("<li><a href=\"studentList?page="+(activePage<pagingnationSize?activePage+1:pagingnationSize)+"&pageSize=10\" aria-label=\"Next\"><span aria-hidden=\"true\">&raquo;</span></a></li>");
